...
public class ViewConstants {
    ...
    public static final DialogInfo AUTHOR_DIALOG =
            new DialogInfo("/fxml/books/author_dialog.fxml", new Size(400, 400), "Author edit");
    public static final DialogInfo ALBUM_DIALOG =
            new DialogInfo("/fxml/music/album_dialog.fxml", new Size(640, 1120), "Album edit");
    ...
    public static final DialogInfo FILM_DETAIL_DIALOG =
            new DialogInfo("/fxml/films/details.fxml", new Size(800, 800), "");
    public static final DialogInfo ACTORS_DIALOG =
            new DialogInfo("/fxml/empty_pane.fxml", new Size(800, 800), "");
